...
export default {
  ...
  created() {
    ...
    this.throttleScroll = this.handleScroll;
    this.throttleResize = this.handleResize;
...
.vue-go-top {
  ...
  &__ripple {
    ...
    //animation time of the white shadow
    &[is-active] {
